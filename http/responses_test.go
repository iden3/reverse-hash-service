...
func TestNodeResponse_MarshalJSON(t *testing.T) {
	...
	data, err := json.Marshal(nodeResponse{leaf})
	require.NoError(t, err)
	want := `{"hash":"2c32381aebce52c0c5c5a1fb92e726f66d977b58a1c8a0c14bb31ef968187325"}`
	...
	data, err = json.Marshal(nodeResponse{middleNode})
	require.NoError(t, err)
	want = `{"hash":"2c32381aebce52c0c5c5a1fb92e726f66d977b58a1c8a0c14bb31ef968187325","left":"658c7a65594ebb0815e1cc20f54284ccdb51bb1625f103c116ce58444145381e","right":"e809a4ed2cf98922910e456f1e56862bb958777f5ff0ea6799360113257f220f"}`
	require.Equal(t, want, string(data))
}
